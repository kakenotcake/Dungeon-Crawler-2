...
public class ItemGenerator {
	 ...
	 * @return the generated Item object
        ...
        public static Item generate() {
                ...
                Item fish = new Item(ItemType.Weapon, "Mighty Fish Lord", 45, 29, 32, PlayerClass.Archer, "You strike the enemy with a big ole' seabass.");
                reserves.add(fish);
		Item spear = new Item(ItemType.Weapon, "Dragonspine Spear", 24, 113, 20, PlayerClass.Assassin, "You strike the enemy with your frigid Dragonspine Spear.");
		reserves.add(spear);
		Item axe = new Item(ItemType.Weapon, "Ebony axe", 28, 200, 37, PlayerClass.Assassin, "You swing your ebony axe and cleave the enemy!");
		reserves.add(axe);
		Item cucco = new Item(ItemType.Weapon, "Golden Cucco", 30, 999, 23, PlayerClass.Bard, "A swarm of mighty cuccos attack your enemy!");
		reserves.add(cucco);
	...
	public static Item generatePlayerSpecificItem() {
		...
		Item skywardHarp = new Item(ItemType.Weapon, "Skyward Harp", 20, 500, 26, PlayerClass.Bard, "You use your Skyward Harp to play a beautiful, deadly song.");
                classItems.add(skywardHarp);
		Item coat = new Item(ItemType.Armor, "Virtuoso's Trench Coat", 36, 90, 18, PlayerClass.Bard);
		classItems.add(coat);
		Item darts = new Item(ItemType.Weapon, "Poison Darts", 9, 64, 16, PlayerClass.Assassin, "Perfect shot! Your poison dart hits your foe in the eye!");
		...
		Item sacredBlade = new Item(ItemType.Weapon, "Goddess Blade", 22, 320, 30, PlayerClass.Paladin, "A heavenly ray of light sears your enemy where they stand!");
		...
		Item wabbajack = new Item(ItemType.Weapon, "Wabbajack", 17, 350, 28, PlayerClass.Mage, "Your Wabbajack turns your enemy into a sweet roll (yum).");
                classItems.add(wabbajack);
		Item prayer = new Item(ItemType.Armor, "Holy Prayer", 33, 777, 12, PlayerClass.Mage);
                classItems.add(prayer);
		Item bow = new Item(ItemType.Weapon, "Great Eagle Bow", 24, 148, 32, PlayerClass.Archer, "A deadly sharp arrow strikes your enemy with a mighty impact.");
		classItems.add(bow);
